...
class Login extends React.Component<Props, State> {
			...
			<Aux>
				<div>
					...
					<input
						...
						id={this.identifiers.userName}
						name={this.identifiers.userName}
					...
					<input
						...
						id={this.identifiers.password}
						name={this.identifiers.password}
						onChange={this.inputTextChangeHandler}
					/>
					{this.rednerErrorMessage()}
					<button
						id={this.identifiers.loginButton}
						name={this.identifiers.loginButton}
						onClick={() => {
	...
	private rednerErrorMessage() {
		...
		if (this.props.loginError === true) {
			errorElement = (
				<div id={this.identifiers.errorMessage}>
					{' '}
					{this.loginError.userNameAndPasswordIncorrectError}{' '}
				</div>
			);
		}
		return errorElement;
	...
	private inputTextChangeHandler = (
